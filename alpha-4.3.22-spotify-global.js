/* ALPHA 4.3.28 · GLOBAL CONTROLS + CALENDAR + NATURAL SWIPE
...
window.alphaSpotifyToggleGlobal4328=toggleRemote;window.alphaSpotifyToggleGlobal4327=toggleRemote;window.alphaSpotifyToggleGlobal4326=toggleRemote;window.alphaSpotifyToggleGlobal4325=toggleRemote;window.alphaSpotifyToggleGlobal4324=toggleRemote;window.alphaSpotifyToggleGlobal4323=toggleRemote;window.alphaSpotifyToggleGlobal4322=toggleRemote;
...
function alignGlobalWithMenu(b){
  ...
  if(r){
    /* O botão Menu tem um offset visual próprio. No Android, a sua caixa DOM fica ~22 px abaixo do círculo visível. */
    b.style.top=Math.round(Math.max(0,r.top-22))+'px';
