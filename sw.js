const CACHE_NAME="olen-v4.4.0-home-swipe-direct-intro-20260914";
...
const NAV_STARTUP_FIX_URL="./olen-4.4.0-navigation-startup-fix.js?v=4.4.0-home-swipe-20260914";
...
const HOME_UX_POLISH_URL="./alpha-4.3.43-home-ux-polish.js?v=4.4.0-home-swipe-20260914";
...
function with440Patch(response){
 ...
 return response.text().then(html=>{
  const tags=[BASE_PATCH_URL,SPOTIFY_PATCH_URL,CALENDAR_GOOGLE_URL,CALENDAR_TIME_URL,PLACE_EXPERIENCE_URL,PLACE_CLEANUP_URL,CHAT_SIDEBAR_URL,CHAT_SIDEBAR_FIX_URL,CHAT_FULLSCREEN_SIDEBAR_FIX_URL,CHAT_FOOTER_ICONS_URL,HOME_BUTTONS_ONLY_URL,CHAT_FOOTER_IMMEDIATE_URL,CHAT_SIDEBAR_FULL_SCROLL_URL,CHAT_SIDEBAR_FIXED_ENDS_URL,CHAT_FOOTER_ICONS_LOCK_URL,HOME_NO_SPOTIFY_URL,HOME_FOOTER_SIX_GRID_URL,INTERNAL_SIDEBAR_NO_SPOTIFY_URL,OLEN_IDENTITY_URL,SPLASH_GUARD_URL,SPLASH_POLISH_URL,HOME_UX_POLISH_URL,NAV_STARTUP_FIX_URL].map(u=>'<script src="'+u+'"><\/script>').join('');
  const firstFrameStyle='<style id="olenFirstFrame440">body.alphaWelcomeActive #alphaWelcomeOverlay{display:grid!important;opacity:1!important;background:#02090d url("./assets/olen-background.png") center/cover no-repeat!important}body.alphaWelcomeActive #alphaWelcomeOverlay>.alphaWelcomeInner{visibility:hidden!important;opacity:0!important;pointer-events:none!important}</style>';
  ...
  const headers=new Headers(response.headers);headers.delete('content-length');headers.set('Cache-Control','no-store');headers.set('X-OLEN-Patch','4.4.0-home-swipe-direct-intro-20260914');return new Response(html,{status:response.status,statusText:response.statusText,headers});
 })
}
