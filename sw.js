const CACHE_NAME="olen-v4.4.0-v107-optical-star-track-bar10";
...
const SPLASH_POLISH_URL="./olen-4.4.0-splash-polish.js?v=4.4.0-optical-star-track-bar10";
...
const SHELL=[
  ...
  "./assets/olen/olen-icon-explora.png","./assets/olen/olen-icon-descobre.png","./assets/olen/olen-icon-vive.png","./assets/olen/olen-icon-repete.png",
  "./assets/olen/olen-text-explora.png","./assets/olen/olen-text-descobre.png","./assets/olen/olen-text-vive.png","./assets/olen/olen-text-repete.png",
...
function with440Patch(response){
  ...
  return response.text().then(html=>{
    ...
    headers.delete("content-length");
    headers.set("Cache-Control","no-store");
    headers.set("X-OLEN-Patch","4.4.0-optical-star-track-bar10");
