/* ALPHA 4.3.43 · INTERNAL SIDEBAR + LONG PRESS POLISH
   The Chat fullscreen capsule is no longer touched here.
   Capsule ownership belongs exclusively to olen-4.4.0-chat-sidebar-fullscreen-fix.js.
*/
(()=>{
'use strict';
...
function applyInternal(){
  ...
  if(brand&&brand.textContent.trim()!=='OLEN')brand.textContent='OLEN';
...
.alphaChatConvActionMenu4330 button{
  ...
  font:700 15px/1.2 system-ui,-apple-system,sans-serif!important;
}
.alphaChatConvActionMenu4330 button+button{margin-top:2px!important}
.alphaChatConvActionMenu4330 button:active{background:rgba(65,167,132,.13)!important}
.alphaChatConvActionMenu4330 svg{
  width:23px!important;
  height:23px!important;
  flex:0 0 23px!important;
  fill:none!important;
  stroke:#d9ebe5!important;
...
setTimeout(apply,540);
setTimeout(apply,1040);

console.info('[ALPHA 4.3.43] Internal sidebar + long-press polish active; Chat capsule delegated to OLEN 4.4.0');
})();